...
<p align="center">
  <img src=".github/menu.png?v=2" width="45%" alt="Menu bar popover with grouped snippets, status dots, and per-snippet toggles">
</p>
<p align="center">
  <img src=".github/settings.png?v=2" width="80%" alt="Snippet editor: a parameterized terminal command, the Parameters table, and the grouped sidebar">
</p>
<p align="center">
